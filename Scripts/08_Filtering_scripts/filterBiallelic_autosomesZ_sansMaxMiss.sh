...
#SBATCH -D /proj/sparrowhybridization/Pitaliae/working/Arianna/08_Filtering/SansMaxMissing

#SBATCH -e ../../Job_logs/08_Filtering_logs/SansMaxMissing/filtering_autosomesZ_%a.err

#SBATCH -o ../../Job_logs/08_Filtering_logs/SansMaxMissing/filtering_autosomesZ_%a.out

#SBATCH -J filtering_autosomesZ_sansMaxMiss
...
vcftools --bcf ../${bcf} --minQ 30 --min-meanDP 5 --max-meanDP 12 --minDP 3  --maxDP 18 \
